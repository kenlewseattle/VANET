...
bool JobDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_totalQueueingTime: pp->setTotalQueueingTime(string2simtime(value)); return true;
        case FIELD_totalServiceTime: pp->setTotalServiceTime(string2simtime(value)); return true;
        case FIELD_totalDelayTime: pp->setTotalDelayTime(string2simtime(value)); return true;
